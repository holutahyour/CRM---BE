     ...
     where T : BaseEntity<long>
{
    ...
    public virtual async Task<Result<TResponse>> GetByIdAsync<TResponse>(long id)
    {
        var result = new Result<TResponse>(false);
    ...
    public virtual async Task<Result<bool>> RemoveAsync(long id)
    {
    ...
    public virtual async Task<Result<bool>> UpdateAsync<TRequest>(long id, TRequest request)
    {
        var result = new Result<bool>(false);
